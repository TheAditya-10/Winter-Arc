...
const FinalSubmissionDetails = ({userSubmissions}) => {

    const endTime = new TZDate(2026, 0, 31, 23, 59, 59, "Asia/Kolkata").getTime();
    ...
    return (
        <div>
            ...
            {/* Timer */}
            <div className="mx-auto rounded-lg p-4 mb-6 w-76 @sm/main:w-96 @lg/main:w-[32rem] @2xl/main:w-[40rem] bg-[#021024] shadow-[0_0_20px_#5689C1] border-2 border-[#616E95] overflow-hidden bg-[url('/challenge-detail/card-background.svg')]">
                <h3 className="font-bold text-xl">CLOSE IN:</h3>
                <div className="font-semibold flex items-center justify-center">
                    <Timer timestamp={endTime} />
                </div>
                {/* <p className="m-auto w-fit">Submissions close automatically</p> */}
            </div>
            ...
            <div className="font-inter">
                <div className="mb-10 mx-auto w-76 @sm/main:w-96 @lg/main:w-[32rem] @2xl/main:w-[40rem] rounded-lg p-4 bg-[#021024] flex flex-col gap-2 shadow-[0_0_20px_#5689C1] border-2 border-[#616E95] overflow-hidden bg-[url('/challenge-detail/card-background.svg')]">
                    ...
                    {!userSubmissions && (<div className="flex items-center w-full justify-around mt-4">
                        {(now > endTime)
                            ? <Button variant={"outline"}>Submission Closed</Button>
...
export default FinalSubmissionDetails